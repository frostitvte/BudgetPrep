<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SummaryPerjawatan.aspx.cs" Inherits="BudgetPrep.SummaryPerjawatan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <asp:Button ID="btnMengurus" runat="server" Text="Mengurus" CssClass="btn btn-primary" OnClick="btnMengurus_Click" />
        <asp:Button ID="btnPerjawatan" runat="server" Text="Perjawatan" CssClass="btn btn-primary"  Enabled="false"/>
            ...
            <div id="BudgetBox" runat="server" class="box">
                ...
                <div id="Div2" class="box-content">
                    <div class="form-horizontal" role="form">
                        ...
                        <button class="btn btn-label-left hidden" type="button" data-toggle="collapse" data-target="#LegendExample" aria-expanded="false" aria-controls="LegendExample">
                        ...
                        <div style="overflow: auto; width: 99%;" class="center-block">
                            <%--AllowPaging="true" PageSize="2" OnPageIndexChanged="gvGroupPerjawatans_PageIndexChanged"--%>
                            ...
                            <asp:GridView ID="gvGroupPerjawatans" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                CssClass="table table-bordered table-striped" DataKeyNames="GroupPerjawatanCode" ShowFooter="true"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <asp:Label ID="lblDecisionModalGroupPerjawatanCode" runat="server" Text="" class="control-label"></asp:Label><br />
