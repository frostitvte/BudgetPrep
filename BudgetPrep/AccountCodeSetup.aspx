<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AccountCodeSetup.aspx.cs" Inherits="BudgetPrep.AccountCodeSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            <%--<asp:Button ID="btnModel" class="btn-info" runat="server" Text="Model"          
            OnClick="btnModel_Click"></asp:Button>--%>
                    ...
                    <div class="form-horizontal" role="form">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-6 col-lg-push-3 col-sm-12">
                                    <div class="col-md-12 col-lg-4">
                                        <asp:Label ID="lblAccountCode" runat="server" class="control-label">Account Code</asp:Label>
                                    </div>
                            ...
                            <%--<div class="row">
                                <div class="col-lg-6 col-lg-push-3 col-sm-12">
                                    <div class="col-md-12 col-lg-4">
                                        <asp:Label ID="lblKeterangan" runat="server" class="control-label">Keterangan</asp:Label>
                                    </div>
                                    <div class="col-md-12 col-lg-8">
                                        <asp:TextBox ID="tbKeterangan" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbKeterangan" ForeColor="Red"
                                            CssClass="failureNotification" ErrorMessage="Keterangan is required." ToolTip="Keterangan is required." Display="Dynamic"
                                            ValidationGroup="SaveValidation"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-lg-push-3 col-sm-12">
                                    <div class="col-md-12 col-lg-4">
                                        <asp:Label ID="lblPengiraan" runat="server" class="control-label">Pengiraan</asp:Label>
                                    </div>
                                    <div class="col-md-12 col-lg-8">
                                        <asp:TextBox ID="tbPengiraan" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="tbPengiraan" ForeColor="Red"
                                            CssClass="failureNotification" ErrorMessage="Pengiraan is required." ToolTip="Pengiraan is required." Display="Dynamic"
                                            ValidationGroup="SaveValidation"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>--%>
                       ...
                       <%-- <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-label-left" OnClick="btnAdd_Click">
                        ...
                        <div style="overflow: auto">
                            <asp:GridView ID="gvAccountCodes" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                CssClass="table table-bordered table-striped table-hover" DataKeyNames="AccountCode"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Pengiraan" HeaderText="Pengiraan" />--%>
