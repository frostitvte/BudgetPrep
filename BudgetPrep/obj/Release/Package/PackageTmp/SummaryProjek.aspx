<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SummaryProjek.aspx.cs" Inherits="BudgetPrep.SummaryProjek" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <asp:Button ID="btnProjek" runat="server" Text="Projek" CssClass="btn btn-primary" Enabled="false" />
    </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                                <asp:Label ID="lblDecisionModalTitle" runat="server" Text="Budget Projek"></asp:Label></h4>
                        </div>
