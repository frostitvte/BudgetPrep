<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PeriodMengurusSetup.aspx.cs" Inherits="BudgetPrep.PeriodMengurusSetup" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-lg-push-3 col-sm-12">
                                    ...
                                    <div class="col-md-12 col-lg-8">
                                        <%--<asp:DropDownList ID="ddlFieldMengurus" runat="server" CssClass="form-control"></asp:DropDownList>--%>
                                        <asp:TextBox ID="tbFieldMengurus" runat="server" Enabled="false" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div id="GridBox" class="box-content">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div style="overflow: auto">
                            <asp:GridView ID="gvPeriodMenguruSetup" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                CssClass="table table-bordered table-striped table-hover" DataKeyNames="PeriodMengurusID,FieldMengurusID"
                                OnRowCommand="gvPeriodMenguruSetup_RowCommand">
                                <Columns>
