<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FieldMengurusSetup.aspx.cs" Inherits="BudgetPrep.FieldMengurusSetup" %>
                    ...
                    <div class="form-horizontal" role="form">
                        <div class="form-group">
                            <%--<div class="row">
                                <div class="col-lg-6 col-lg-push-3 col-sm-12">
                                    <div class="col-md-12 col-lg-4">
                                        <label class="control-label">FieldMengurus Code</label>
                                    </div>
                                    <div class="col-md-12 col-lg-8">
                                        <asp:TextBox ID="tbFieldMengurusID" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </div>--%>
                            <div class="row">
                                <div class="col-lg-6 col-lg-push-3 col-sm-12">
                                    <div class="col-md-12 col-lg-4">
                                        <asp:Label ID="lblFieldMengurus" runat="server" class="control-label">Field Mengurus</asp:Label>
                                    </div>
                                    <div class="col-md-12 col-lg-8">
                                        <asp:TextBox ID="tbFieldMengurusDesc" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="tbFieldMengurusDesc" ForeColor="Red"
                            ...
                            <%--<div class="row">
                                <div class="col-lg-6 col-lg-push-3 col-sm-12">
                                    <div class="col-md-12 col-lg-4">
                                        <label class="control-label">FieldMengurus SDesc</label>
                                    </div>
                                    <div class="col-md-12 col-lg-8">
                                        <asp:TextBox ID="tbFieldMengurusSDesc" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </div>--%>
                            <div class="row">
                ...
                <div id="GridBox" class="box-content">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div style="overflow: auto">
                            <asp:GridView ID="gvFieldMenguruSetup" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                CssClass="table table-bordered table-striped table-hover" DataKeyNames="FieldMengurusID"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FieldMengurusDesc" HeaderText="Field Mengurus Description" />
                                    <%--<asp:BoundField DataField="FieldMengurusSDesc" HeaderText="FieldMengurusSDesc" />--%>
