    ...
    public partial class StatusMengurus : System.Web.UI.Page
    {
        ...
        private void GetData()
        {
            try
            {
                ...
                bool CanEdit = false;
                List<BudgetMenguru> BudgetData = new BudgetMengurusBAL().GetBudgetMengurusStatus(GetSelectedSegmentDetails(), ref CanEdit)
        ...
        protected void objTemp_OnCustomStatusClicked(object sender, CustomEvenArgs e)
        {
            try
            {
                ...
                List<int> budids = new BudgetMengurusBAL().GetMengurusSegDtls()
                ...
                List<BudgetMenguru> budData = new BudgetMengurusBAL().GetBudgetMengurus()
                ...
                var jundata = new BudgetMengurusBAL().GetMengurusSegDtls()
                    .AsEnumerable()
