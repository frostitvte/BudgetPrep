<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SegmentDetails.aspx.cs" Inherits="BudgetPrep.SegmentDetails" %>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-lg-push-3 col-sm-12">
                                    <div class="col-md-12 col-lg-4">
                                        <asp:Label ID="lblDetailCode" runat="server" class="control-label">Detail Code</asp:Label>
                                    </div>
                                    <div class="col-md-12 col-lg-8">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="tbCode" ForeColor="Red"
                                            CssClass="failureNotification" ErrorMessage="Code is required." ToolTip="Code is required." Display="Dynamic"
                                            ValidationGroup="SaveValidation"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegExpValidatorCode" runat="server" ControlToValidate="tbCode" ForeColor="Red"
                                            CssClass="failureNotification" ErrorMessage="Invalid No of characters." ToolTip="Invalid No of characters." Display="Dynamic"
                                            ValidationGroup="SaveValidation" ValidationExpression="^[\s\S]{1,8}$"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                       ...
                       <%-- <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-label-left" OnClick="btnAdd_Click">
                        ...
                        <div style="overflow: auto">
                            <asp:GridView ID="gvSegmentDetails" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                ...
                                OnRowCommand="gvSegmentDetails_RowCommand" OnRowDataBound="gvSegmentDetails_RowDataBound">
                                <Columns>
