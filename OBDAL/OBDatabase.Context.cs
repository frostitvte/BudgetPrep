...
namespace OBDAL
{
    ...
    public partial class OBEntities : DbContext
    {
        public OBEntities()
            : base("name=OBEntities")
        {
        }
        ...
        public DbSet<BudgetPerjawatan> BudgetPerjawatans { get; set; }
        ...
        public DbSet<JuncBgtPerjawatanSegDtl> JuncBgtPerjawatanSegDtls { get; set; }
        ...
        public DbSet<BPLanguage> BPLanguages { get; set; }
        public DbSet<MasterUser> MasterUsers { get; set; }
        public DbSet<YearUploadSetup> YearUploadSetups { get; set; }
        public DbSet<BudgetProjek> BudgetProjeks { get; set; }
        public DbSet<JuncBgtProjekSegDtl> JuncBgtProjekSegDtls { get; set; }
    }
}
